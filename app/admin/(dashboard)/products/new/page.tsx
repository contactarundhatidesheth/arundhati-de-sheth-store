...
export default async function NewProductPage() {
  ...
  const guaranteedCategories = ["Earring", "Ring", "Necklace", "Bracelet", "Pendant", "Collab"];
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <form action={saveProduct} style={{ background: '#fff', padding: '32px', borderRadius: '8px', border: '1px solid #eaeaea', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div style={{ display: 'flex', gap: '24px' }}>
          <FilterPills name="metal" options={uniqueMetals} label="Metal" multiple={true} />
        ...
        <div style={{ padding: '24px', background: '#f8f8f8', borderRadius: '8px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px' }}>
            <label style={{ fontSize: '0.85rem', fontWeight: '500' }}>Custom Specifications</label>
            <p style={{ fontSize: '0.75rem', color: '#666', margin: '-4px 0 4px 0' }}>Enter detailed specifications here.</p>
            <AdminRichText name="customSpecs" placeholder="Specifications details..." />
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '16px', background: '#f5f5f5', borderRadius: '4px', border: '1px solid #eaeaea' }}>
          <input type="checkbox" name="isActive" id="isActive" defaultChecked={true} style={{ width: '18px', height: '18px' }} />
