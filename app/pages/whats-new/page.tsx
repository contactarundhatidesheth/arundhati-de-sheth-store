      ...
      <section style={{ maxWidth: '1400px', margin: '0 auto', padding: '120px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '48px', alignItems: 'center', marginBottom: '120px' }}>
          <div style={{ position: 'relative', width: '100%', aspectRatio: '3/4', background: '#F5F5F5' }}>
            <Image src="https://cdn.shopify.com/s/files/1/0275/0287/0572/files/disha2.jpg" alt="Disha Patani" fill style={{ objectFit: 'cover' }} />
          </div>
          ...
          <div style={{ position: 'relative', width: '100%', aspectRatio: '3/4', background: '#F5F5F5' }}>
            <Image src="https://cdn.shopify.com/s/files/1/0275/0287/0572/files/disha1.jpg" alt="Disha Patani" fill style={{ objectFit: 'cover' }} />
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '48px', alignItems: 'center', marginBottom: '120px' }}>
          <div style={{ position: 'relative', width: '100%', aspectRatio: '3/4', background: '#F5F5F5' }}>
            <Image src="https://cdn.shopify.com/s/files/1/0275/0287/0572/files/alia2.jpg" alt="Alia Bhatt" fill style={{ objectFit: 'cover' }} />
          </div>
          <div style={{ textAlign: 'center', padding: '0 24px' }}>
          ...
          <div style={{ position: 'relative', width: '100%', aspectRatio: '3/4', background: '#F5F5F5' }}>
            <Image src="https://cdn.shopify.com/s/files/1/0275/0287/0572/files/alia1.jpg" alt="Alia Bhatt" fill style={{ objectFit: 'cover' }} />
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '48px', alignItems: 'center' }}>
          <div style={{ position: 'relative', width: '100%', aspectRatio: '3/4', background: '#F5F5F5' }}>
             <Image src="https://cdn.shopify.com/s/files/1/0275/0287/0572/files/PC_Reception_Mumbai.jpg" alt="Priyanka Chopra" fill style={{ objectFit: 'cover' }} />
          </div>
          <div style={{ textAlign: 'center', padding: '0 24px' }}>
          ...
          <div style={{ position: 'relative', width: '100%', aspectRatio: '3/4', background: '#F5F5F5' }}>
            {/* Note: I couldn't find the exact second PC image from the scraper, using a placeholder product image to maintain the strict 3-col layout */}
             <Image src="https://cdn.shopify.com/s/files/1/0275/0287/0572/products/IMG-5690.jpg" alt="Jewelry" fill style={{ objectFit: 'cover' }} />
          </div>
        </div>
