...
export default async function DynamicSeenOnPage({ params }: { params: { id: string } }) {
    const supabase = getSupabaseAdmin();
    const { data, error } = await supabase.from('seen_on_features').select('*').eq('id', params.id).single();
